...
const ICONS = {
  ...
  itch: (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path fill="currentColor" d="M2 6c0-1.103.897-2 2-2h16c1.103 0 2 .897 2 2v12c0 1.103-.897 2-2 2H4c-1.103 0-2-.897-2-2V6zm4.5 3.5v2h2v-2h-2zm5 0v2h2v-2h-2zm5 0v2h2v-2h-2z" />
    </svg>
  ),
  eventful: (
    <svg viewBox="0 0 24 24" aria-hidden="true">
...
export default function SocialLinks() {
  return (
    <aside id="social" className="social-card social-card--prominent glass-card interactive-card">
      <div className="social-card-header">
        <span className="eyebrow">Connect</span>
        <h3>Social & links</h3>
      </div>
      <p className="social-card-copy">Find my work, code, and projects across the web.</p>
      <ul className="social-list">
        {SOCIAL_LINKS.map((link) => (
          <li key={link.id}>
            ...
            >
              <span className="social-link-icon">{ICONS[link.id] || ICONS.eventful}</span>
